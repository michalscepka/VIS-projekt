...
VALUES ('Škoda', 'Fabia III', '1T1 2222', 250, 5, '1,0 TSI (70 kW)', 5.2, 1, 1);
INSERT INTO vozidlo(znacka, model, spz, cena_za_den, pocet_dveri, motor, spotreba, aktivni, pobocka_id)
VALUES ('Škoda', 'Fabia III', '1T1 0001', 260, 5, '1,4 TSI (92 kW)', 6.1, 1, 1);
INSERT INTO vozidlo(znacka, model, spz, cena_za_den, pocet_dveri, motor, spotreba, aktivni, pobocka_id)
VALUES ('Škoda', 'Octavia III', '1T1 0002', 290, 5, '2,0 TDI (110 kW)', 4.1, 1, 1);
INSERT INTO vozidlo(znacka, model, spz, cena_za_den, pocet_dveri, motor, spotreba, aktivni, pobocka_id)
VALUES ('Škoda', 'Octavia III', '1T1 0003', 290, 5, '2,0 TDI (110 kW)', 6.2, 1, 1);
INSERT INTO vozidlo(znacka, model, spz, cena_za_den, pocet_dveri, motor, spotreba, aktivni, pobocka_id)
VALUES ('Škoda', 'Superb III', '1T1 0004', 300, 5, '2,0 TDI (140 kW)', 7.2, 1, 1);
